                  ...
                  subtitle: Container(
                    ...
                    child: Text.rich(
                      TextSpan(children: [
                        ...
                        TextSpan(text: "$status \n", style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.bold, color: Colors.red)),
                        TextSpan(text: "Contact Number: ", style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.bold)),
                        TextSpan(text: customerData.contactNo, style: TextStyle(color: Colors.black)),
                      ],
                      ),
                    ),
                  ),
                          ...
                          Column(
                            ...
                            children: [
                              ListTile(
                                ...
                                subtitle: Container(
                                  padding: EdgeInsets.only(top: 5),
                                  child: Text(widget.delivery.cancellationMessage, style: TextStyle(color: Colors.black,),),
                                ),
                              ),
                            ],
                          ),
