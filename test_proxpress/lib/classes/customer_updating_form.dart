...
class _CustomerUpdateState extends State<CustomerUpdate> {
  ...
  String defaultProfilePic =
      'https://firebasestorage.googleapis.com/v0/b/proxpress-629e3.appspot.com/o/profile-user.png?alt=media&token=6727618b-4289-4438-8a93-a4f14753d92e';
  ...
  Widget build(BuildContext context) {
    ...
    Stream<Customer> customerStream =
        DatabaseService(uid: user.uid).customerData;
    ...
    return user == null
        ...
        : GestureDetector(
            onTap: () {
              ...
              _sessionTimer =
                  new Timer(Duration(seconds: duration), handleTimeOut);
                              ...
                              children: <Widget>[
                                            ...
                                            child: Container(
                                              ...
                                              child: IconButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    final profilePictureDestination =
                                                        'Customers/${user.uid}/profilepic_${user.uid}_$datetime';
                                                    ...
                                                    if (saveDestination !=
                                                            null &&
                                                        saveDestination.length >
                                                            0) {
                                                      saveDestination =
                                                          saveDestination.substring(
                                                              0,
                                                              saveDestination
                                                                      .length -
                                                                  1);
                                ...
                                Container(
                                  child: TextFormField(
                                    ...
                                    onChanged: (val) =>
                                        setState(() => _currentContactNo = val),
                                  ),
                                ),
                                Container(
                                  child: Center(
                                ...
                                Container(
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: 'Password:',
                                      hintText:
                                          dots(customerData.password.length),
                                      floatingLabelBehavior:
                                          FloatingLabelBehavior.always,
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (_updateKey.currentState
                                            ...
                                            if (_currentEmail != null)
                                              validCustomer.updateCurrentEmail(
                                                  _currentEmail);
